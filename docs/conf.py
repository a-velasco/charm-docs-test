...
# don't know yet)
ogp_site_url = 'https://canonical-charm-docs-test.readthedocs-hosted.com/'
...
exclude_patterns = [
    'doc-cheat-sheet*',
    #'mongodb-k8s/explanation/u*',
    'mongodb-k8s/tutorial/[cdemor]*',
    'mongodb-k8s/reference/[ort]*',
    'mongodb-k8s/howto/[acemr]*',
    'mongodb-vm/explanation/[su]*',
    'mongodb-vm/tutorial/[acdeops]*',
    'mongodb-vm/tutorial/int*',
    'mongodb-vm/reference/[ort]*',
    'mongodb-vm/howto/[acdemrs]*',
    '',
    ]
